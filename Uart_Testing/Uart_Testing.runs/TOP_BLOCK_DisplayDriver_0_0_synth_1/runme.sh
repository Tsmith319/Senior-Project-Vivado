...
HD_PWD='C:/Users/Derek/Desktop/Vivado/Uart_Testing/Uart_Testing.runs/TOP_BLOCK_DisplayDriver_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TOP_BLOCK_DisplayDriver_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TOP_BLOCK_DisplayDriver_0_0.tcl
