...
(* CORE_GENERATION_INFO = "design_1,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=design_1,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=8,numReposBlks=8,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=4,da_bram_cntlr_cnt=2,da_ps7_cnt=1,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "design_1.hwdef" *) 
module design_1
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
  ...
  design_1_axi_cdma_0_0 axi_cdma_0
       (.cdma_introut(axi_cdma_0_cdma_introut),
        ...
        .s_axi_lite_araddr(axi_smc_1_M01_AXI_ARADDR),
        .s_axi_lite_aresetn(rst_ps7_0_100M_peripheral_aresetn),
        .s_axi_lite_arready(axi_smc_1_M01_AXI_ARREADY),
        .s_axi_lite_arvalid(axi_smc_1_M01_AXI_ARVALID),
        .s_axi_lite_awaddr(axi_smc_1_M01_AXI_AWADDR),
        .s_axi_lite_awready(axi_smc_1_M01_AXI_AWREADY),
        .s_axi_lite_awvalid(axi_smc_1_M01_AXI_AWVALID),
        .s_axi_lite_bready(axi_smc_1_M01_AXI_BREADY),
        .s_axi_lite_bresp(axi_smc_1_M01_AXI_BRESP),
        .s_axi_lite_bvalid(axi_smc_1_M01_AXI_BVALID),
        .s_axi_lite_rdata(axi_smc_1_M01_AXI_RDATA),
        .s_axi_lite_rready(axi_smc_1_M01_AXI_RREADY),
        .s_axi_lite_rresp(axi_smc_1_M01_AXI_RRESP),
        .s_axi_lite_rvalid(axi_smc_1_M01_AXI_RVALID),
        .s_axi_lite_wdata(axi_smc_1_M01_AXI_WDATA),
        .s_axi_lite_wready(axi_smc_1_M01_AXI_WREADY),
        .s_axi_lite_wvalid(axi_smc_1_M01_AXI_WVALID));
