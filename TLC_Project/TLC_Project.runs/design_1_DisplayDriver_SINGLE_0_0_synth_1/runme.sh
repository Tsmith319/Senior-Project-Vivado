...
HD_PWD='C:/Users/Derek/Desktop/Vivado/TLC_Project/TLC_Project.runs/design_1_DisplayDriver_SINGLE_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_DisplayDriver_SINGLE_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_DisplayDriver_SINGLE_0_0.tcl
