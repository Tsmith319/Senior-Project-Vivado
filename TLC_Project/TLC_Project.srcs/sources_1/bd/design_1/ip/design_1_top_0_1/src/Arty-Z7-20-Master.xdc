...
set_property -dict { PACKAGE_PIN T14   IOSTANDARD LVCMOS33 } [get_ports { SOUT  }]; #IO_L5P_T0_34            Sch=CK_IO0
...
set_property -dict { PACKAGE_PIN V13   IOSTANDARD LVCMOS33 } [get_ports { GSCLK  }]; #IO_L3N_T0_DQS_34        Sch=CK_IO3
