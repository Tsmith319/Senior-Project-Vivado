...
HD_PWD='C:/Users/TaySm/OneDrive/Documents/GitHub/Senior-Project-Vivado/Vision_Project/Vision_Project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log VISION_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source VISION_wrapper.tcl -notrace
