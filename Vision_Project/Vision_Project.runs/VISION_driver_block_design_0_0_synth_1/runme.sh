...
HD_PWD='C:/Users/TaySm/OneDrive/Documents/GitHub/Senior-Project-Vivado/Vision_Project/Vision_Project.runs/VISION_driver_block_design_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log VISION_driver_block_design_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source VISION_driver_block_design_0_0.tcl
