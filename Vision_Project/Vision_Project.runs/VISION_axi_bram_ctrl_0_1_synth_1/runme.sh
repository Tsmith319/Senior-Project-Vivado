...
HD_PWD='C:/Users/TaySm/OneDrive/Documents/GitHub/Senior-Project-Vivado/Vision_Project/Vision_Project.runs/VISION_axi_bram_ctrl_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log VISION_axi_bram_ctrl_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source VISION_axi_bram_ctrl_0_1.tcl
