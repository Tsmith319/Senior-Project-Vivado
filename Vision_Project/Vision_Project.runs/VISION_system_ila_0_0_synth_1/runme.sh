...
HD_PWD='C:/Users/TaySm/OneDrive/Documents/GitHub/Senior-Project-Vivado/Vision_Project/Vision_Project.runs/VISION_system_ila_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log VISION_system_ila_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source VISION_system_ila_0_0.tcl
