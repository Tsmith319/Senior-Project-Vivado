...
HD_PWD='C:/github/Senior-Project-Vivado/Vision_Project/Vision_Project.runs/VISION_xlslice_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log VISION_xlslice_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source VISION_xlslice_1_0.tcl
