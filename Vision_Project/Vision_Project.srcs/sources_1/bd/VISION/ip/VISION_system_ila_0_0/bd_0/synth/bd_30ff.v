...
module bd_30ff
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK, CLK_DOMAIN VISION_processing_system7_0_0_FCLK_CLK1, FREQ_HZ 250000000, PHASE 0.000" *) input clk;
  input [2:0]probe0;
  input [0:0]probe1;
  input [0:0]probe2;
  input [0:0]probe3;
  ...
  bd_30ff_ila_lib_0 ila_lib
       (.clk(clk_1),
        .probe0(probe0_1),
        .probe1(probe1_1),
        .probe10(SLOT_0_BRAM_addr_1),
        .probe11(SLOT_1_BRAM_en_1),
        .probe12(SLOT_1_BRAM_rst_1),
        .probe13(SLOT_1_BRAM_dout_1),
        .probe14(SLOT_1_BRAM_addr_1),
        .probe2(probe2_1),
        .probe3(probe3_1),
        .probe4(probe4_1),
        .probe5(probe5_1),
        .probe6(probe6_1),
        .probe7(SLOT_0_BRAM_en_1),
        .probe8(SLOT_0_BRAM_rst_1),
        .probe9(SLOT_0_BRAM_dout_1));
endmodule
