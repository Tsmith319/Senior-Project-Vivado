...
#set_property -dict { PACKAGE_PIN Y18   IOSTANDARD LVCMOS33   SLEW FAST   DRIVE 24 } [get_ports { sout_9_0 }]; #IO_L17P_T2_34 Sch=JA1_P
#set_property -dict { PACKAGE_PIN Y19   IOSTANDARD LVCMOS33   SLEW FAST   DRIVE 24 } [get_ports { latch_9_0 }]; #IO_L17N_T2_34 Sch=JA1_N
#set_property -dict { PACKAGE_PIN Y16   IOSTANDARD LVCMOS33   SLEW FAST   DRIVE 24 } [get_ports { sclk_9_0 }]; #IO_L7P_T1_34 Sch=JA2_P
#set_property -dict { PACKAGE_PIN Y17   IOSTANDARD LVCMOS33   SLEW FAST   DRIVE 24 } [get_ports { gsclk_9_0 }]; #IO_L7N_T1_34 Sch=JA2_N
...
#set_property -dict { PACKAGE_PIN Y14   IOSTANDARD LVCMOS33   SLEW FAST   DRIVE 24 } [get_ports { sout_7_0 }]; #IO_L8N_T1_34 Sch=JB1_N
#set_property -dict { PACKAGE_PIN W14   IOSTANDARD LVCMOS33   SLEW FAST   DRIVE 24 } [get_ports { latch_7_0 }]; #IO_L8P_T1_34 Sch=JB1_P
#set_property -dict { PACKAGE_PIN T10   IOSTANDARD LVCMOS33   SLEW FAST   DRIVE 24 } [get_ports { sclk_7_0 }]; #IO_L1N_T0_34 Sch=JB2_N
#set_property -dict { PACKAGE_PIN T11   IOSTANDARD LVCMOS33   SLEW FAST   DRIVE 24 } [get_ports { gsclk_7_0 }]; #IO_L1P_T0_34 Sch=JB2_P
#set_property -dict { PACKAGE_PIN W16   IOSTANDARD LVCMOS33   SLEW FAST   DRIVE 24 } [get_ports { sout_8_0 }]; #IO_L18N_T2_34 Sch=JB3_N
#set_property -dict { PACKAGE_PIN V16   IOSTANDARD LVCMOS33   SLEW FAST   DRIVE 24 } [get_ports { latch_8_0 }]; #IO_L18P_T2_34 Sch=JB3_P
#set_property -dict { PACKAGE_PIN W13   IOSTANDARD LVCMOS33   SLEW FAST   DRIVE 24 } [get_ports { sclk_8_0 }]; #IO_L4N_T0_34 Sch=JB4_N
#set_property -dict { PACKAGE_PIN V12   IOSTANDARD LVCMOS33   SLEW FAST   DRIVE 24 } [get_ports { gsclk_8_0 }]; #IO_L4P_T0_34 Sch=JB4_P
...
set_property -dict { PACKAGE_PIN Y11   IOSTANDARD LVCMOS33 SLEW FAST   DRIVE 24 } [get_ports { latch_9_0 }]; #IO_L18N_T2_13 Sch=CK_A0
set_property -dict { PACKAGE_PIN Y12   IOSTANDARD LVCMOS33 SLEW FAST   DRIVE 24 } [get_ports {  sout_9_0 }]; #IO_L20P_T3_13 Sch=CK_A1
set_property -dict { PACKAGE_PIN W11   IOSTANDARD LVCMOS33 SLEW FAST   DRIVE 24 } [get_ports { gsclk_7_0 }]; #IO_L18P_T2_13 Sch=CK_A2
set_property -dict { PACKAGE_PIN V11   IOSTANDARD LVCMOS33 SLEW FAST   DRIVE 24 } [get_ports { sclk_7_0  }]; #IO_L21P_T3_DQS_13 Sch=CK_A3
set_property -dict { PACKAGE_PIN T5    IOSTANDARD LVCMOS33 SLEW FAST   DRIVE 24 } [get_ports { latch_7_0 }]; #IO_L19P_T3_13 Sch=CK_A4
set_property -dict { PACKAGE_PIN U10   IOSTANDARD LVCMOS33 SLEW FAST   DRIVE 24 } [get_ports { sout_7_0  }]; #IO_L12N_T1_MRCC_13 Sch=CK_A5
...
set_property -dict { PACKAGE_PIN B20   IOSTANDARD LVCMOS33 SLEW FAST   DRIVE 24 } [get_ports { sclk_9_0  }]; #IO_L1N_T0_AD0N_35 Sch=AD0_N
set_property -dict { PACKAGE_PIN C20   IOSTANDARD LVCMOS33 SLEW FAST   DRIVE 24 } [get_ports { gsclk_9_0 }]; #IO_L1P_T0_AD0P_35 Sch=AD0_P
set_property -dict { PACKAGE_PIN F20   IOSTANDARD LVCMOS33 SLEW FAST   DRIVE 24 } [get_ports { gsclk_8_0 }]; #IO_L15N_T2_DQS_AD12N_35 Sch=AD12_N
set_property -dict { PACKAGE_PIN F19   IOSTANDARD LVCMOS33 SLEW FAST   DRIVE 24 } [get_ports { sclk_8_0  }]; #IO_L15P_T2_DQS_AD12P_35 Sch=AD12_P
set_property -dict { PACKAGE_PIN A20   IOSTANDARD LVCMOS33 SLEW FAST   DRIVE 24 } [get_ports { latch_8_0 }]; #IO_L2N_T0_AD8N_35 Sch=AD8_N
set_property -dict { PACKAGE_PIN B19   IOSTANDARD LVCMOS33 SLEW FAST   DRIVE 24 } [get_ports { sout_8_0  }]; #IO_L2P_T0_AD8P_35 Sch=AD8_P

##ChipKit Digital I/O Low

set_property -dict { PACKAGE_PIN T14   IOSTANDARD LVCMOS33   SLEW FAST   DRIVE 24 } [get_ports { sout_0_0 }]; #IO_L5P_T0_34 Sch=CK_IO0
set_property -dict { PACKAGE_PIN U12   IOSTANDARD LVCMOS33   SLEW FAST   DRIVE 24 } [get_ports { latch_0_0 }]; #IO_L2N_T0_34 Sch=CK_IO1
set_property -dict { PACKAGE_PIN U13   IOSTANDARD LVCMOS33   SLEW FAST   DRIVE 24 } [get_ports { sclk_0_0 }]; #IO_L3P_T0_DQS_PUDC_B_34 Sch=CK_IO2
set_property -dict { PACKAGE_PIN V13   IOSTANDARD LVCMOS33   SLEW FAST   DRIVE 24 } [get_ports { gsclk_0_0 }]; #IO_L3N_T0_DQS_34 Sch=CK_IO3
set_property -dict { PACKAGE_PIN V15   IOSTANDARD LVCMOS33   SLEW FAST   DRIVE 24 } [get_ports { sout_1_0 }]; #IO_L10P_T1_34 Sch=CK_IO4
set_property -dict { PACKAGE_PIN T15   IOSTANDARD LVCMOS33   SLEW FAST   DRIVE 24 } [get_ports { latch_1_0 }]; #IO_L5N_T0_34 Sch=CK_IO5
set_property -dict { PACKAGE_PIN R16   IOSTANDARD LVCMOS33   SLEW FAST   DRIVE 24 } [get_ports { sclk_1_0 }]; #IO_L19P_T3_34 Sch=CK_IO6
set_property -dict { PACKAGE_PIN U17   IOSTANDARD LVCMOS33   SLEW FAST   DRIVE 24 } [get_ports { gsclk_1_0 }]; #IO_L9N_T1_DQS_34 Sch=CK_IO7
set_property -dict { PACKAGE_PIN V17   IOSTANDARD LVCMOS33   SLEW FAST   DRIVE 24 } [get_ports { sout_6_0 }]; #IO_L21P_T3_DQS_34 Sch=CK_IO8
set_property -dict { PACKAGE_PIN V18   IOSTANDARD LVCMOS33   SLEW FAST   DRIVE 24 } [get_ports { latch_6_0 }]; #IO_L21N_T3_DQS_34 Sch=CK_IO9
set_property -dict { PACKAGE_PIN T16   IOSTANDARD LVCMOS33   SLEW FAST   DRIVE 24 } [get_ports { sclk_6_0 }]; #IO_L9P_T1_DQS_34 Sch=CK_IO10
set_property -dict { PACKAGE_PIN R17   IOSTANDARD LVCMOS33   SLEW FAST   DRIVE 24 } [get_ports { gsclk_6_0 }]; #IO_L19N_T3_VREF_34 Sch=CK_IO11
set_property -dict { PACKAGE_PIN P18   IOSTANDARD LVCMOS33 } [get_ports { gpio2_io_i_0[0] }]; #IO_L23N_T3_34 Sch=CK_IO12
set_property -dict { PACKAGE_PIN N17   IOSTANDARD LVCMOS33 PULLUP TRUE } [get_ports { UART1_RX_0 }]; #IO_L23P_T3_34 Sch=CK_IO13

##ChipKit Digital I/O High

set_property -dict { PACKAGE_PIN U5    IOSTANDARD LVCMOS33   SLEW FAST   DRIVE 24 } [get_ports { sout_2_0 }]; #IO_L19N_T3_VREF_13 Sch=CK_IO26
set_property -dict { PACKAGE_PIN V5    IOSTANDARD LVCMOS33   SLEW FAST   DRIVE 24 } [get_ports { latch_2_0 }]; #IO_L6N_T0_VREF_13 Sch=CK_IO27
set_property -dict { PACKAGE_PIN V6    IOSTANDARD LVCMOS33   SLEW FAST   DRIVE 24 } [get_ports { sclk_2_0 }]; #IO_L22P_T3_13 Sch=CK_IO28
set_property -dict { PACKAGE_PIN U7    IOSTANDARD LVCMOS33   SLEW FAST   DRIVE 24 } [get_ports { gsclk_2_0 }]; #IO_L11P_T1_SRCC_13 Sch=CK_IO29
set_property -dict { PACKAGE_PIN V7    IOSTANDARD LVCMOS33   SLEW FAST   DRIVE 24 } [get_ports { sout_3_0 }]; #IO_L11N_T1_SRCC_13 Sch=CK_IO30
set_property -dict { PACKAGE_PIN U8    IOSTANDARD LVCMOS33   SLEW FAST   DRIVE 24 } [get_ports { latch_3_0 }]; #IO_L17N_T2_13 Sch=CK_IO31
set_property -dict { PACKAGE_PIN V8    IOSTANDARD LVCMOS33   SLEW FAST   DRIVE 24 } [get_ports { sclk_3_0 }]; #IO_L15P_T2_DQS_13 Sch=CK_IO32
set_property -dict { PACKAGE_PIN V10   IOSTANDARD LVCMOS33   SLEW FAST   DRIVE 24 } [get_ports { gsclk_3_0 }]; #IO_L21N_T3_DQS_13 Sch=CK_IO33
set_property -dict { PACKAGE_PIN W10   IOSTANDARD LVCMOS33   SLEW FAST   DRIVE 24 } [get_ports { sout_4_0 }]; #IO_L16P_T2_13 Sch=CK_IO34
set_property -dict { PACKAGE_PIN W6    IOSTANDARD LVCMOS33   SLEW FAST   DRIVE 24 } [get_ports { latch_4_0 }]; #IO_L22N_T3_13 Sch=CK_IO35
set_property -dict { PACKAGE_PIN Y6    IOSTANDARD LVCMOS33   SLEW FAST   DRIVE 24 } [get_ports { sclk_4_0 }]; #IO_L13N_T2_MRCC_13 Sch=CK_IO36
set_property -dict { PACKAGE_PIN Y7    IOSTANDARD LVCMOS33   SLEW FAST   DRIVE 24 } [get_ports { gsclk_4_0 }]; #IO_L13P_T2_MRCC_13 Sch=cCK_IO37
set_property -dict { PACKAGE_PIN W8    IOSTANDARD LVCMOS33   SLEW FAST   DRIVE 24 } [get_ports { sout_5_0 }]; #IO_L15N_T2_DQS_13 Sch=CK_IO38
set_property -dict { PACKAGE_PIN Y8    IOSTANDARD LVCMOS33   SLEW FAST   DRIVE 24 } [get_ports { latch_5_0 }]; #IO_L14N_T2_SRCC_13 Sch=CK_IO39
set_property -dict { PACKAGE_PIN W9    IOSTANDARD LVCMOS33   SLEW FAST   DRIVE 24 } [get_ports { sclk_5_0 }]; #IO_L16N_T2_13 Sch=CK_IO40
set_property -dict { PACKAGE_PIN Y9    IOSTANDARD LVCMOS33   SLEW FAST   DRIVE 24 } [get_ports { gsclk_5_0 }]; #IO_L14P_T2_SRCC_13 Sch=CK_IO41
