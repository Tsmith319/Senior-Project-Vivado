...
EAStep vivado -log driver_block_design_sout_module_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source driver_block_design_sout_module_1_0.tcl
