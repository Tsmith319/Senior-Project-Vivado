...
ISEStep( "vivado",
         "-log driver_block_design_mean_machine_module_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source driver_block_design_mean_machine_module_0_0.tcl" );
