...
#
# Generated by export_simulation on Sun Nov 11 13:54:48 -0700 2018
#
################################################################################
...
'-reset_run' switch to the './driver_block_design.sh' script.

./driver_block_design.sh -reset_run
...
./driver_block_design.sh -noclean_files

For more information on the script, please type './driver_block_design.sh -help'.
