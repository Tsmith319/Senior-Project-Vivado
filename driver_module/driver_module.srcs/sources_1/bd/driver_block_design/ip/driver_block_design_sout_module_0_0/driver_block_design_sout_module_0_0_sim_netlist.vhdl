...
entity driver_block_design_sout_module_0_0_sout_module is
  port (
    ...
    \buf_num[0]\ : in STD_LOGIC_VECTOR ( 0 to 0 )
  );
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of driver_block_design_sout_module_0_0_sout_module : entity is "sout_module";
end driver_block_design_sout_module_0_0_sout_module;

architecture STRUCTURE of driver_block_design_sout_module_0_0_sout_module is
  signal \^o\ : STD_LOGIC_VECTOR ( 0 to 0 );
  signal \b_addr1_carry__0_n_3\ : STD_LOGIC;
  signal \b_addr1_carry_i_1__0_n_1\ : STD_LOGIC;
  signal \b_addr1_carry_i_1__0_n_2\ : STD_LOGIC;
  signal \b_addr1_carry_i_1__0_n_3\ : STD_LOGIC;
  signal b_addr1_carry_i_1_n_0 : STD_LOGIC;
  signal \b_addr1_carry_i_2__0_n_0\ : STD_LOGIC;
  signal b_addr1_carry_i_2_n_0 : STD_LOGIC;
  signal \b_addr1_carry_i_3__0_n_0\ : STD_LOGIC;
  signal b_addr1_carry_i_3_n_0 : STD_LOGIC;
  signal \b_addr1_carry_i_4__0_n_0\ : STD_LOGIC;
  signal b_addr1_carry_i_4_n_0 : STD_LOGIC;
  signal \b_addr1_carry_i_5__0_n_0\ : STD_LOGIC;
  signal b_addr1_carry_i_5_n_0 : STD_LOGIC;
  signal \b_addr1_carry_i_6__0_n_0\ : STD_LOGIC;
  signal b_addr1_carry_i_6_n_0 : STD_LOGIC;
  signal b_addr1_carry_i_7_n_0 : STD_LOGIC;
...
b_addr1_carry: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3) => \b_addr1_carry_i_3__0_n_0\,
      S(2) => \b_addr1_carry_i_4__0_n_0\,
      S(1) => \b_addr1_carry_i_5__0_n_0\,
      S(0) => \b_addr1_carry_i_6__0_n_0\
    );
...
\b_addr1_carry_i_1__0\: unisim.vcomponents.CARRY4
     port map (
      CI => '0',
      CO(3) => CO(0),
      CO(2) => \b_addr1_carry_i_1__0_n_1\,
      CO(1) => \b_addr1_carry_i_1__0_n_2\,
      CO(0) => \b_addr1_carry_i_1__0_n_3\,
      CYINIT => '0',
      DI(3) => b_addr1_carry_i_3_n_0,
      DI(2) => b_addr1_carry_i_4_n_0,
      DI(1 downto 0) => B"01",
      O(3 downto 1) => b_addr2(12 downto 10),
      O(0) => \^o\(0),
      S(3) => b_addr1_carry_i_5_n_0,
      S(2) => b_addr1_carry_i_6_n_0,
      S(1) => b_addr1_carry_i_7_n_0,
      S(0) => b_addr3(0)
    );
...
\b_addr1_carry_i_2__0\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
\b_addr1_carry_i_3__0\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"9"
    )
        port map (
...
b_addr1_carry_i_4: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
\b_addr1_carry_i_4__0\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"D2"
    )
        port map (
...
b_addr1_carry_i_5: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
\b_addr1_carry_i_5__0\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"96"
    )
        port map (
...
\b_addr1_carry_i_6__0\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
b_addr1_carry_i_7: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
b_addr1_carry_i_8: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity driver_block_design_sout_module_0_0 is
  port (
    clk : in STD_LOGIC;
    sclk : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of driver_block_design_sout_module_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of driver_block_design_sout_module_0_0 : entity is "driver_block_design_sout_module_0_0,sout_module,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of driver_block_design_sout_module_0_0 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of driver_block_design_sout_module_0_0 : entity is "package_project";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of driver_block_design_sout_module_0_0 : entity is "sout_module,Vivado 2018.2";
end driver_block_design_sout_module_0_0;

architecture STRUCTURE of driver_block_design_sout_module_0_0 is
  signal \<const0>\ : STD_LOGIC;
  signal \<const1>\ : STD_LOGIC;
  signal \^b_addr\ : STD_LOGIC_VECTOR ( 28 downto 0 );
  signal b_addr1_carry_i_9_n_3 : STD_LOGIC;
  signal b_addr2 : STD_LOGIC_VECTOR ( 9 to 9 );
  signal \^clk\ : STD_LOGIC;
  signal inst_n_7 : STD_LOGIC;
  signal \^reset\ : STD_LOGIC;
  signal NLW_b_addr1_carry_i_9_CO_UNCONNECTED : STD_LOGIC_VECTOR ( 3 downto 1 );
  signal NLW_b_addr1_carry_i_9_O_UNCONNECTED : STD_LOGIC_VECTOR ( 3 downto 0 );
...
b_addr1_carry_i_9: unisim.vcomponents.CARRY4
     port map (
      CI => inst_n_7,
      CO(3 downto 1) => NLW_b_addr1_carry_i_9_CO_UNCONNECTED(3 downto 1),
      CO(0) => b_addr1_carry_i_9_n_3,
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3 downto 0) => NLW_b_addr1_carry_i_9_O_UNCONNECTED(3 downto 0),
      S(3 downto 0) => B"0001"
    );
...
inst: entity work.driver_block_design_sout_module_0_0_sout_module
     port map (
      ...
      \buf_num[0]\(0) => b_addr1_carry_i_9_n_3,
      clk => \^clk\,
